...
public class Triage {
    ...
    public Triage(WebDriver driver) {

        this.driver = driver;
    }

    public void TriageModule() throws InterruptedException {
        ...
        Thread.sleep(2000);
        WebElement close1=driver.findElement(xpath("(//*[text()=\"Close\"])[1]"));
        close1.click();
...
//        Thread.sleep(3000);
//        WebElement close2=driver.findElement(xpath("(//*[text()=\"Close\"])[1]"));
//        close2.click();
//        Thread.sleep(2000);
//        WebElement close3=driver.findElement(xpath("(//*[text()=\"Close\"])[1]"));
//        close3.click();
...
//        //searching on drugname
        ...
        Thread.sleep(20000);
        WebElement clickingdrugname=driver.findElement(xpath("//*[text()=\" 61392-0657-90 / DOXAZOSIN MESYLATE TABLETS\"]"));
...
//        //Choosing Diagnosis
        ...
        Thread.sleep(10000);
        WebElement feverdiagnosis=driver.findElement(xpath("//*[text()=\"R50 - Fever of other and unknown origin\"]"));
...
//       // Alcholicstatus
        ...
        //clicking on save button
        Thread.sleep(3000);
        WebElement save5=driver.findElement(xpath("(//*[text()=\" Save \"])[4]"));
        save5.click();
...
//        //choosing Respiratory
        ...
        //clicking on save button
        Thread.sleep(3000);
        WebElement save6=driver.findElement(xpath("(//*[text()=\" Save \"])[5]"));
        save6.click();
...
//        //adding Nutrition
        ...
        //clicking on save button
        Thread.sleep(3000);
        WebElement save7=driver.findElement(xpath("(//*[text()=\" Save \"])[6]"));
        save7.click();
...
//        //Adding FunctionalCognitive
        ...
        //clicking on save button
        Thread.sleep(3000);
        WebElement save8=driver.findElement(xpath("(//*[text()=\" Save \"])[7]"));
        save8.click();
...
//
        ...
        //clicking on save button
        Thread.sleep(3000);
        WebElement save9=driver.findElement(xpath("(//*[text()=\" Save \"])[8]"));
        save9.click();

        //clicking the close button
        Thread.sleep(3000);
        WebElement close9=driver.findElement(xpath("//*[text()=\"Close\"]"));
        close9.click();
